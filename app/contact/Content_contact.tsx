...
export default function Content_contact() {
  ...
  return (
    <main className="relative min-h-dvh pt-28 pb-16 px-4 bg-gray-100 flex items-center justify-center overflow-hidden">
      <Image
        src="/assets/images/contact/foto-contact-bg.jpg"
        alt="Fondo contacto Nuria Makeup"
        fill
        className="absolute inset-0 object-cover z-0 grayscale opacity-10 pointer-events-none select-none"
        priority
        sizes="100vw"
      />
            ...
            <div>
              ...
              {channel === "whatsapp" && waTouched && !isNameValid ? (
                <p className="text-xs text-red-700 mt-1">
                  El nombre es obligatorio para poder dirigirme a ti por
                  WhatsApp.
                </p>
              ) : null}
            </div>
