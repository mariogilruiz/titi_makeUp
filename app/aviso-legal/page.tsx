...
export const metadata: Metadata = {
  ...
  description:
    "Informacion legal y condiciones de uso del sitio web de Nuria Makeup.",
};
      ...
      <main className="w-full min-h-screen bg-neutral-100 pt-28 pb-16">
        <section className="max-w-4xl mx-auto px-6 space-y-6 text-neutral-800">
          ...
          <div className="space-y-3">
            ...
            <p>
              En cumplimiento de la normativa vigente, se informa que la
              titularidad de este sitio web corresponde a Nuria Makeup.
            </p>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              servicios de maquillaje profesional para bodas, eventos y
              formacion.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              logotipos y diseno, son propiedad de Nuria Makeup o se utilizan
              con autorizacion, quedando prohibida su reproduccion no
              autorizada.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              Nuria Makeup no se responsabiliza de los danos derivados del uso
              del sitio web ni de posibles interrupciones del servicio por
              causas tecnicas.
            </p>
          </div>
        </section>
